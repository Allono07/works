...
public class SavingsAccountManager {
    ...
    public static void main(String[] args) throws IOException {
        ...
        HashMap<Integer, Integer> accountBalances = new HashMap<>();
        ...
        while(true) {
            ...
            try {
                ...
                if (accountNum >= 1 && accountNum <= numCustomers) {
                    ...
                    int accountBalance = accountBalances.get(accountNum);
                    switch (choice) {
                        case 1:
                    ...
                    accountBalances.put(accountNum, accountBalance);
                } else {
